...
| Automated verification | Formatting, lint, typecheck, full tests, evidence validation, dependency audit, secret scan, and offline evaluator path all pass on the final candidate | **PASSED: 227/227 tests, strict evidence valid, both npm audits zero, offline 10/10** |
